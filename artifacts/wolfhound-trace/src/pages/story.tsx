    ...
    <main className="relative min-h-screen bg-background">
      ...
      <header className="relative min-h-[60vh] flex items-center pl-6 md:pl-28 pr-6 md:pr-12">
        ...
        <div className="absolute left-4 md:left-6 top-1/2 -translate-y-1/2">
          <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground -rotate-90 origin-left block whitespace-nowrap">STORY</span>
        </div>
        <div className="flex-1 w-full">
          ...
          <h2 className="font-[var(--font-bebas)] text-muted-foreground/60 text-[clamp(1rem,3vw,2rem)] mt-6 tracking-wide">The Story Behind Wolfhound Trace</h2>
          <p className="mt-12 max-w-md font-mono text-sm text-muted-foreground leading-relaxed">The spirit of the Irish Wolfhound carried into the digital age.</p>
          <div className="mt-16">
        ...
        <div className="absolute bottom-8 right-8 md:bottom-12 md:right-12">
          <div className="border border-border px-4 py-2 font-mono text-[10px] uppercase tracking-widest text-muted-foreground">Wolfhound Trace / Story</div>
        </div>
      </header>
      ...
      <div className="relative z-10 px-6 md:pl-28 md:pr-12 py-16 md:py-24 -mt-[70px]">
        <article className="max-w-3xl">
          <section className="mb-16 relative">
            ...
            />
            <h3 className="font-[var(--font-bebas)] text-3xl md:text-4xl tracking-tight mb-6">THE <span className="text-accent">WOLFHOUND</span></h3>
            <p className="font-mono text-sm leading-relaxed mb-6 mt-[10px]" style={{ color: 'rgb(192,192,192)' }}>The Irish Wolfhound is a creature of profound duality — possessing both quiet nobility and an unyielding drive when on the hunt. It is a creature of purpose, bred for patience, precision, and loyalty. When wolves moved unseen among the flock, it was the wolfhound who sensed the danger first.</p>
            <p className="font-mono text-sm leading-relaxed" style={{ color: 'rgb(192,192,192)' }}>With an instinct honed over centuries, the wolfhound could identify the wolf hiding in sheep&apos;s clothing — the predator disguised among the innocent, waiting for its moment to strike. This innate ability to see through deception and detect danger where others saw only the ordinary made the wolfhound invaluable. <span className="text-foreground font-medium">Silent, steady, and relentless,</span> it tracked every trace until the truth revealed itself.</p>
          </section>
          ...
          <section className="mb-16">
            ...
            <p className="font-mono text-sm leading-relaxed mb-6" style={{ color: 'rgb(192,192,192)' }}>Our philosophy values accuracy over haste. Just as a wolfhound never loses the scent, we do not stop until every digital trace aligns with the truth. This isn&apos;t just our work — it&apos;s our instinct.</p>
            <p className="font-mono text-sm leading-relaxed" style={{ color: 'rgb(192,192,192)' }}>In the complex world of open-source intelligence (OSINT) and digital forensics, true results require silent precision, keen observation, and the patience to track digital footprints across the globe without alerting the target.</p>
          </section>
