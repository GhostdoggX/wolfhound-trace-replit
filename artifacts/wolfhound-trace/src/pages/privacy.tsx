      ...
      <article className="max-w-3xl mx-auto px-6 md:px-12 py-16 md:py-24">
        ...
        <div className="space-y-12 font-mono text-sm leading-relaxed text-foreground/80">
          {[
            ...
            ["4. Purposes of Processing", "We process personal data for the purpose of providing our services, responding to enquiries, managing client relationships, conducting due diligence, supporting analytic engagements, maintaining business records, complying with legal and regulatory obligations, and protecting the security and integrity of our systems and operations. We do not use personal data for unrelated or incompatible purposes."],
          ...
          <section className="pt-8 border-t border-border/30">
            ...
            <p>Wolfhound Trace provides professional open-source intelligence (OSINT), digital intelligence analysis, and due diligence services. All analytic work is conducted in compliance with applicable laws and regulations, including GDPR and data protection standards.</p>
          </section>
        </div>
        ...
        <footer className="mt-24 pt-8 border-t border-border/20">
          ...
          <p className="mt-2 font-mono text-[10px] text-muted-foreground">Professional OSINT and intelligence services worldwide</p>
