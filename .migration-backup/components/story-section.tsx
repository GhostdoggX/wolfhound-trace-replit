    ...
    <section ref={sectionRef} id="story" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={contentRef} className="max-w-3xl">
        <p className="font-mono text-sm md:text-base text-muted-foreground leading-relaxed mb-8">
          The Irish Wolfhound is a creature of profound duality — possessing both quiet nobility and an unyielding drive when on the hunt. 
          It is a creature of purpose, bred for patience, precision, and loyalty.
        </p>

        <p className="font-mono text-sm md:text-base text-muted-foreground leading-relaxed mb-8">
          When wolves moved unseen among the flock, it was the wolfhound who sensed the danger first. With an instinct sharpened over centuries, 
          the wolfhound could identify the wolf hiding in sheep&apos;s clothing — the predator disguised among the innocent. 
        ...
        <p className="font-mono text-sm md:text-base text-muted-foreground leading-relaxed mb-12">
          At Wolfhound Trace, we carry that same spirit into the digital world. Our mission is to uncover the hidden — 
          the wolves moving quietly through networks, data trails, and online shadows.
        </p>
